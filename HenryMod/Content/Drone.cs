...
{
    internal class Drone : CharacterBase
    {
        public override string bodyName => "Drone";
        ...
        public override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            characterPortrait = Modules.Assets.LoadCharacterIconGeneric("Drone"),
            ...
            subtitleNameToken = HolomancerPlugin.developerPrefix + "_Drone_BODY_SUBTITLE",
