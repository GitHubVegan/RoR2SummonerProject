...
namespace HolomancerMod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        public const string HENRY_PREFIX = "_HENRY_BODY_";
        ...
        {
            bodyName = "HenryBody",
            bodyNameToken = "_HENRY_BODY_NAME",
            subtitleNameToken = "_HENRY_BODY_SUBTITLE",
        ...
        public override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef("_HENRY_BODY_DEFAULT_SKIN_NAME",
