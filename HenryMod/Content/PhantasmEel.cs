...
{
    internal class PhantasmEel : CharacterBase
    {
        public override string bodyName => "PhantasmEel";

        public override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            armor = 50f,
            armorGrowth = 0f,
            bodyName = "PhantasmEelBody",
            bodyNameToken = "Eel",
            bodyNameToClone = "FlyingVermin",
            bodyColor = Color.grey,
            characterPortrait = Modules.Assets.LoadCharacterIconGeneric("PhantasmEel"),
            ...
            subtitleNameToken = HolomancerPlugin.developerPrefix + "_PhantasmEel_BODY_SUBTITLE",
