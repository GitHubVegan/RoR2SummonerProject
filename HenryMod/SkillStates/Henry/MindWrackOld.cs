...
{
	internal class MindWrackOld : BaseSkillState
	{
			...
			if (PrimaryPhantasm.SummonablesList1.Count > 0)
				{
					...
					foreach (CharacterMaster CM in PrimaryPhantasm.SummonablesList1)
					{
						...
						//MindWrackOldClone.damagecoefficient += 0.5f;
		...
		public override void OnExit()
		{
			...
			base.OnExit();
			base.GetComponent<RoR2.SkillLocator>().primary.UnsetSkillOverride(1, SkillCatalog.GetSkillDef(SkillCatalog.FindSkillIndexByName("MindWrackOld")), RoR2.GenericSkill.SkillOverridePriority.Contextual);
