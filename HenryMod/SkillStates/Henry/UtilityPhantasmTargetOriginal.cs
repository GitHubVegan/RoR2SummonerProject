...
{
    public class UtilityPhantasmTargetOriginal : BaseSkillState
    {
        ...
        //{
            //GameObject newBody = PrefabAPI.InstantiateClone(Resources.Load<GameObject>("prefabs/characterbodies/MercBody"), "UtilityPhantasmTargetOriginalBody", true);
            ...
            //        GameObject newBody = Prefabs.CreatePrefab("UtilityPhantasmTargetOriginalBody", "mdlPhantasmSword",bodyInfo);
        ...
        {
            GameObject newMaster = PrefabAPI.InstantiateClone(Resources.Load<GameObject>("prefabs/charactermasters/MercMonsterMaster"), "UtilityPhantasmTargetOriginalMaster", true);
            newMaster.GetComponent<CharacterMaster>().bodyPrefab = UtilityPhantasmTargetOriginalBody;
