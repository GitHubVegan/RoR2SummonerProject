...
namespace HolomancerMod.SkillStates
{
    public class PhantasmGround : BaseSkillState
    {
        ...
        private void FireBullet()
        {
            ...
            Util.PlaySound(EntityStates.Assassin.Weapon.SlashCombo.attackString, base.gameObject);
        ...
        bool grounded(BulletAttack attack, ref BulletAttack.BulletHit hitInfo)
        {
