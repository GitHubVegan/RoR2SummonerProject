...
namespace HolomancerMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = HolomancerPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = HolomancerPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = HolomancerPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = HolomancerPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            HolomancerPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            HolomancerPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            HolomancerPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
